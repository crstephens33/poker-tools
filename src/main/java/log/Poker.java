...
public class Poker {
    ...
    private static final String CLEAN_OUTPUT_FILE_NAME = "%s_clean_%sv%s.txt";
    ...
    private static String getCleanOutputFileName(final String inputFileName, boolean hiddenHands) {
        ...
        return String.format(CLEAN_OUTPUT_FILE_NAME, inputFileRemoveExt, hidden, PROGRAM_VERSION);
    }
